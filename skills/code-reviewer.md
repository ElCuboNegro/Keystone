...
## Activated when: code has been written or modified and needs a quality, security, or correctness review
...
| 2 | SECURITY | MEDIUM | `folder_lock.py:88` | PBKDF2 iteration count is configurable but not validated | Enforce minimum 100k iterations |
...
